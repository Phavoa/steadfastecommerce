...
const defaultAddress: ShippingDetails = {
  firstName: "",
  lastName: "",
  email: "",
  phone: "",
...
export const ShippingAddressSection = ({
  ...
  const [shippingDetails, setShippingDetails] =
    useState<ShippingDetails>(defaultAddress);
  ...
  useEffect(() => {
    ...
    } // <-- fixed: close the `if (savedDetails)` block here

    // If you want to use the user fallback, uncomment and adapt below:
    // else if (user) {
    //   const userDetails: ShippingDetails = {
  ...
  const updateShippingDetails = (newDetails: ShippingDetails) => {
